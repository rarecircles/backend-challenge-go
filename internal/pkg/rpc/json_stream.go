...
// changes made upstream to `encoding/json/stream.go` file.
//
// The decoding part is commented to ease including new changes made upstream. We only
// use the "specialized" marshaler and not the unmarshaler.
//
