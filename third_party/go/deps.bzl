...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:0zhec2I8zGnjWcKyLl6i3gPqKANCCn5e9xmviEEeX6s=",
        version = "v1.13.4",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_rarecircles_backend_challenge_go",
        importpath = "github.com/rarecircles/backend-challenge-go",
        sum = "h1:u8glZGGo7HvGNjG7IhFq0hJuWxKInsAKPTPRpls47N8=",
        version = "v0.0.0-20211112223822-2839efbe5b80",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:DDUVuG21RMgeB/bn4leclUI/837y6cQCD4w8hb5797k=",
        version = "v0.8.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:LtBIgSqNhkuC9gA3BFjGy5obHQT1lnmNsMDFSqWzQ5w=",
        version = "v0.0.0-20221002003631-540bb7301a08",
    )
    go_repository(
